...
<button type="button" id="add_button" class="btn btn-info "> <i class="material-
icons" style="font-size:15px">add_circle</i> Add</button>
...
<input type="text" name="data_action" id="data_action" value="Insert" />
